package cn.haier.bio.medical.ltb.entity;

public class LTBDataEntity implements Cloneable {
    ...
    public boolean isAlarmsEquals(Object obj) {
        ...
        if (!(obj instanceof LTBDataEntity)) {
            return false;
        }
        LTBDataEntity other = (LTBDataEntity) obj;
